      ...
      <div className="flex flex-col justify-center items-center bg-gray-100 w-full min-h-[430px] flex-grow px-6 py-8">
        ...
        <div className="text-sm md:text-lg text-justify text-gray-600 max-w-3xl leading-relaxed mt-6 space-y-4">
          ...
          <ul className="list-disc list-inside">
            <li>
              🌟 <strong>Productos para el cuidado del cabello:</strong> Ofrecemos una amplia selección de productos que no solo reparan, sino que transforman tu cabello. Desde <strong>shampoos profesionales</strong>, tratamientos capilares intensivos, hasta aceites nutritivos.
            </li>
            <li>
              🌟 <strong>Calidad garantizada:</strong> Cada artículo en nuestro catálogo ha sido cuidadosamente seleccionado y probado para garantizar los mejores resultados para tu cabello y piel.
            </li>
            <li>
              🌟 <strong>Soluciones personalizadas:</strong> Sabemos que no todos los cabellos son iguales. Por eso, te ayudamos a encontrar el producto perfecto para tu tipo de cabello, ya sea seco, graso, dañado o teñido.
            </li>
          </ul>
        </div>
        ...
        <div className="text-sm md:text-lg text-justify text-gray-600 max-w-3xl mt-6 space-y-4">
        ...
        <div className="text-sm md:text-lg text-justify text-gray-600 max-w-3xl leading-relaxed mt-8 space-y-4">
          ...
          <ul className="list-disc list-inside">
            <li><strong>Especialistas en cuidado capilar:</strong> Desde productos hidratantes hasta tratamientos para el cabello dañado.</li>
            <li><strong>Tendencias en belleza:</strong> Encuentra lo último en productos de belleza y cuidado personal que están revolucionando el mercado.</li>
            <li><strong>Resultados garantizados:</strong> Todo lo que necesitas para lucir un cabello sano, fuerte y lleno de vida.</li>
          </ul>
        </div>
      </div>
    );
